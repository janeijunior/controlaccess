...
class Estados extends CI_Controller {
    ...
    function gerenciar(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'vEstados')){
        ...
        $config['base_url'] = base_url().'index.php/estados/gerenciar/';
        $config['total_rows'] = $this->estados_model->count('uf');
        ...
        $this->data['results'] = $this->estados_model->get($config['per_page'],$this->uri->segment(3));
        $this->data['view'] = 'estados/estados';
    ...
    function visualizar() {
        ...
        $this->data['view'] = 'estados/visualizarEstado';
        $this->load->view('tema/topo', $this->data);
    ...
    function excluir()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'dEstados')) {
